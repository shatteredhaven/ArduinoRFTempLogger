...
3) update the python script with your user name, password, and the spreadsheet name
4) run!

For more information please see the Adafruit tutorial for more information. 